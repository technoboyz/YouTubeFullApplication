...
{
    public interface IDataReadService<TKey, TModel, TList, TDetails, TRequest>
        where TKey : struct
    ...
    public interface IDataWriteService<TKey, TModel, TPost, TPut>
        where TKey : struct
        where TModel : IEntity<TKey>
    ...
    public interface IArchiveableDataWriteService<TKey, TModel, TPost, TPut>
        : IDataWriteService<TKey, TModel, TPost, TPut>
        where TKey : struct
        where TModel : IEntity<TKey>
        where TPut : IEntity<TKey>
    {
    ...
    public abstract class DataReadService<TKey, TEntity, TModel, TList, TDetails, TRequest>
        where TKey : struct
        ...
        where TRequest : RequestBaseDto
    {
        ...
        protected DataReadService(DbContext context, IMapper mapper)
        {
    ...
    public abstract class DataWriteService<TKey, TEntity, TModel, TPost, TPut>
        where TKey : struct
        where TEntity : Entity<TKey>
        where TModel : IEntity<TKey>
        where TPut : IEntity<TKey>
    {
        ...
        protected DataWriteService(DbContext context, IMapper mapper)
        {
            this.context = context;
            this.mapper = mapper;
        }
    ...
    public abstract class ArchiveableDataWriteService<TKey, TEntity, TModel, TPost, TPut>
        : DataWriteService<TKey, TEntity, TModel, TPost, TPut>,
        IArchiveableDataWriteService<TKey, TModel, TPost, TPut>
        where TKey : struct
        where TEntity : ArchiveableEntity<TKey>
        where TModel : IEntity<TKey>
        where TPut : IEntity<TKey>
    {
        protected ArchiveableDataWriteService(DbContext context, IMapper mapper) : base(context, mapper) { }
